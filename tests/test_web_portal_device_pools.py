...
class WebPortalDevicePoolsTest(unittest.TestCase):
    ...
    def test_device_pool_page_renders_refresh_and_connect_actions(self) -> None:
        ...
        self.assertIn("name='device_id' placeholder='192.168.31.99:5555' required", html)
        self.assertIn("name='pair_device_id' placeholder='192.168.31.101:40539' required", html)
        self.assertIn("name='pairing_code' inputmode='numeric' placeholder='645916' required", html)
        self.assertIn("name='connect_device_id' placeholder='192.168.31.101:42201' required", html)
