# Regression Rules Config Snapshot

- snapshot_id: snapshot_bbe91d75caa742e5a468100ea85d1848
- snapshot_type: regression
- created_at: 2025-07-20T04:46:11.431369
- created_by: cli
...
```json
{
  ...
  "comparability_notes": [
    ...
    "Scenario comparison currently maps scenario scope to task template_type.",
    "One comparison side has no usable monitoring session data under the current filters."
  ],
  "issue_count": 2,
  "metric_count": 4,
  "issues": [
  ...
  "metrics": [
    {
      "metric_key": "power_usage",
      "label": "Power Usage",
      "unit": "raw",
      "higher_is_worse": true,
      "regression_result": "insufficient_data",
