# Replay Snapshot Smoke

- snapshot_id: snapshot_1231dbaec2414c4c884f71cec441e2bf
- snapshot_type: replay
- created_at: 2025-07-20T08:19:15.964486
- created_by: replay_smoke
...
```json
{
  ...
  "first_change_type": "fingerprint_changed"
}
```
...
```json
{
  ...
  "candidate": {
    "path": "/tmp/asl_replay_rules.json",
    "fingerprint_rule_version": "v1"
  },
  "filters": {
    "task_id": "",
