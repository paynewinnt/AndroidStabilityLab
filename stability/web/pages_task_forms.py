...
class ApplicationTaskFormsMixin:
    ...
    def _task_option(item: Mapping[str, Any]) -> str:
        ...
        template_label = ApplicationTaskFormsMixin._task_template_plain_label(template_type)
    ...
    def _task_params_help() -> str:
        ...
        return ApplicationTaskFormsMixin._help_group_html(groups)
