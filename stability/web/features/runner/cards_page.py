...
class RunnerCardsPageMixin:
    ...
    def _device_pool_device_editor(
        ...
        *,
        ...
        connection_text = RunnerCardsPageMixin._device_state_label(connection_state, empty="未同步")
        availability_text = RunnerCardsPageMixin._device_state_label(availability_state, empty="未同步")
