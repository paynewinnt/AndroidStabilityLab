...
class ApplicationIntegrationActionsMixin:
        ...
        *,
        ...
        return {
            ...
            "webhook": {
                ...
                "delivery_channel": str(getattr(webhook, "delivery_channel", "") or ""),
            },
        }
    ...
    def _handle_create_release_submission(
        ...
        *,
        ...
        device_sync = None
        if (
            not self._form_bool(payload, "skip_device_sync", default=False)
            and device_service is not None
            and hasattr(device_service, "sync_devices")
        ):
